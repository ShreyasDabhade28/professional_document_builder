...
// }
    ...
    const handleChange=()=>{
      ...
      localStorage.setItem("phone",phn.current.value);
      localStorage.setItem("email",eid.current.value);
      localStorage.setItem("address",add.current.value);
      localStorage.setItem("city",city.current.value);
      localStorage.setItem("postcode",pcode.current.value);
      localStorage.setItem("state",state.current.value);
      localStorage.setItem("country",country.current.value);
      localStorage.setItem("jobtitle",jobtitle.current.value);
    }
